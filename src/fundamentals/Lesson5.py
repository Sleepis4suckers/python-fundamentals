...
def math_modulus(value3: int, value4: float) -> float:
    ...
    problem. If you input a float value, you will return a
    float value"""
...
def math_expon(value5, value6):
    ...
    operand to the power of thr second"""
...
def member_op():
    """ Membership operators test to see if a sequence is in an object """

    kilo = 'same'
    lake = 'some kind of words'
    mind = 'kind'
    result_a = kilo in lake or mind in lake
